...
// console.log (blu)   // this is error, can't change change const value but var value can be changed
...
1. let     => new variable, can be reassigned
2. const   => const variable, can't be reassigned
3. var     => old variable, don't use because of limitations
...
// an api is like a messanger that helps to different software programs talk to eachother or exchange data or comments
//